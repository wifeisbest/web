        ...
        <section class="detail">
            <article itemscope itemtype="http://schema.org/Article">
                ...
                <div class="pots__body" itemprop="articleBody">
                    ...
                    <p>
                        <strong>URL: </strong> Là 1 chuỗi ký tự văn bản giúp bạn có thể tìm thấy trang web ,video, hình ảnh,..trên internet, ví dụ để đến được với bài viết này 
                    ...
                    <p>
                        ...
                        đúng những gì bạn cần thông qua đường dẫn url bạn đã cung cấp . Nếu bạn chưa rõ ràng lắm về http bạn có thể xem qua bài viết này của mình 
                        <a href="/giao-thuc-tcp-ip-http-va-https"> Giao Thức là gì</a>

                    </p>
                    <p>
                        <strong>HTML: </strong> Ngôn ngữ đánh dấu siêu văn bản, 1 văn bản thuần túy là 1 tờ giấy bạn viết mà trên tờ giấy đó chỉ toàn là chữ, còn ngôn ngữ siêu văn bản 
                        là văn bản trong đó có 1 cấu trúc riêng mà bạn phải bắt buộc tuân theo, trong văn bản có thể chứa hình ảnh, video, âm thanh,...

                    </p>
                    <h2 class="section__h2">Website là gì ?</h2>
                    <p>
                        1 <strong>Website</strong> là tập hợp rất nhiều các siêu văn bản các siêu văn này lại được kết nối lại với nhau bằng rất nhiều cách.
                        Bạn thường hay nghe cụm từ "1 trang web" khi nghe đến cụm từ này chúng ta cần hiểu được là trang web này chứa rất nhiều các tài liệu 
                        siêu văn bản và mỗi 1 tài liệu siêu văn bản trong đó chính là 1 web page (1 trang tài liệu trong rất nhiều trang web đó);
                        Bạn cần phân biệt được website và web page nhé !. Trong thực tế vẫn có những website chỉ chứa 1 trang duy nhất, 1 tài liệu siêu văn bản duy nhất.
                        
                    </p>
                    <p>
                       Sau khi đã có khái niệm website là gì thì tùy theo mục đính tạo ra website đó mà chúng ta phân loại ra các loại website khác nhau.
                       <strong>Blog </strong> định nghĩa của nó chính là " Nhật ký web" 1 dạng nhật ký trực tuyến đến đây thì bạn cũng rõ rồi đấy 
                       đã là nhật ký thì là nó có những ý kiến cá nhân của người viết nhật ký, chủ đề của blog thì thường liên quan đến kinh nghiệm của người viết blog.
                       Tùy theo mục đính của blog mà chúng ta cũng có rất nhiều loại blog như , blog ẩm thực, blog tin học, blog được làm cha ...
                        
                    </p>
                    
                    <p>
                        Một website cơ bản thì chỉ là nơi cung cấp thông tin cho người sử dụng nó chỉ có 1 chiều, còn <strong> Web app</strong> 
                        khác biệt lớn nhất cơ bản nhất nằm ở khả năng tương tác người đọc hoàn toàn có thể tương tác ngược trở lại như cho phép tạo tài khoản , đăng bài, gửi hình ảnh ...
